...
use binance_sdk::spot::{SpotRestApi, rest_api::TickerParams};
...
#[tokio::main]
async fn main() {
    let rest_config = ConfigurationRestApi::builder().build()?;
    let rest_client = SpotRestApi::production(rest_config);

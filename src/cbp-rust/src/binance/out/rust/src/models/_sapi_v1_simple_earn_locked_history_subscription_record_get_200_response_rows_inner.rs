...
impl SapiV1SimpleEarnLockedHistorySubscriptionRecordGet200ResponseRowsInner {
    pub fn new(position_id: String, purchase_id: i64, project_id: String, time: i64, asset: String, amount: String, lock_period: String, r#type: String, source_account: String, amt_from_spot: String, amt_from_funding: String, status: String) -> SapiV1SimpleEarnLockedHistorySubscriptionRecordGet200ResponseRowsInner {

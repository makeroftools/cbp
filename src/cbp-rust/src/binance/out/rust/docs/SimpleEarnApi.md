...
[**sapi_v1_simple_earn_locked_set_redeem_option_get**](SimpleEarnApi.md#sapi_v1_simple_earn_locked_set_redeem_option_get) | **GET** /sapi/v1/simple-earn/locked/setRedeemOption | Set Locked Product Redeem Option(USER_DATA)
...
## sapi_v1_simple_earn_locked_set_redeem_option_get

> models::SapiV1MarginMaxLeveragePost200Response sapi_v1_simple_earn_locked_set_redeem_option_get(position_id, timestamp, signature, redeem_to, recv_window)
...
**timestamp** | **i64** | UTC timestamp in ms | [required] |
**signature** | **String** | Signature | [required] |
**redeem_to** | Option<**String**> | SPOT,FLEXIBLE, default FLEXIBLE |  |
**recv_window** | Option<**i64**> | The value cannot be greater than 60000 |  |
...
> models::SapiV1SimpleEarnLockedSubscribePost200Response sapi_v1_simple_earn_locked_subscribe_post(project_id, amount, timestamp, signature, auto_subscribe, source_account, redeem_to, recv_window)

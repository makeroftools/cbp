...
impl SapiV1SimpleEarnFlexibleHistorySubscriptionRecordGet200ResponseRowsInner {
    pub fn new(amount: String, asset: String, time: i64, purchase_id: i64, product_id: String, r#type: String, source_account: String, amt_from_spot: String, amt_from_funding: String, status: String) -> SapiV1SimpleEarnFlexibleHistorySubscriptionRecordGet200ResponseRowsInner {
